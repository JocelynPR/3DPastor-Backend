...
insert into usuarios(usuario_nombre, email, telefono, contrasena, rol_id)
  values ("Antonio González Navarrete", "navarrete.antonio.2301@gmail.com", "+52 3329467527", "pikachu69", 1);
  
insert into usuarios(usuario_nombre, email, telefono, contrasena, rol_id)
  values ("Mirta Adriana Tapia Don", "mirta.atd@gmail.com","+52 1 33 1531 6295", "charizard666", 1);
insert into usuarios(usuario_nombre, email, telefono, contrasena, rol_id)
  values ("Misael Edgar Zepeda Díaz", "misaeltup@gmail.com","+52 1 55 7209 7393", "mewtwo123", 1);
insert into usuarios(usuario_nombre, email, telefono, contrasena, rol_id)
  values ("Jocelyn Karina Peña Reyes", "jocelyn.p.reyes332b@gmail.com", "+52 5546935091", "snorlax99", 1);
insert into usuarios(usuario_nombre, email, telefono, contrasena, rol_id)
  values ("Yazmin Valeria Morales Martínez", "myaz5848@gmail.com", "5620893079", "bulbasuar567", 1);
insert into usuarios(usuario_nombre, email, telefono, contrasena, rol_id)
